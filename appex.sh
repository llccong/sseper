...
URLKernel='https://raw.githubusercontent.com/llccong/sseper/main/serverSpeeder_kernel/serverSpeeder.txt'
...
wget --no-check-certificate -q -O "/tmp/appex/apxfiles/bin/acce-"$KNV"-["$KNA"_"$KNN"_"$KNK"]" "https://raw.githubusercontent.com/llccong/sseper/main/serverSpeeder_kernel/master/$MyKernel"
